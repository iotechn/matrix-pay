...
public abstract class MatrixBasePayResult implements Serializable {
     ...
     * @return the t
     */
    public static <T extends MatrixBasePayResult> T fromXML(String xmlString, Class<T> clz) {
    ...
    public void checkResult(WxPayService wxPayService, String signType, boolean checkSuccess) throws MatrixPayException {
        ...
        if (getSign() != null && !SignUtils.checkSign(map, signType, wxPayService.getConfig().getMchKey())) {
            ...
            throw new MatrixPayException("参数格式校验错误！");
        }
        ...
        if (checkSuccess) {
            ...
            if (!successStrings.contains(StringUtils.trimToEmpty(getReturnCode()).toUpperCase())
                ...
                throw MatrixPayException.from(this);
            }
        }
    }
}
