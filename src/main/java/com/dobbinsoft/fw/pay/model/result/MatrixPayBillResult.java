...
public class MatrixPayBillResult implements Serializable {
     ...
     */
    public static MatrixPayBillResult fromRawBillResultString(String responseContent, String billType) {
        switch (billType) {
            case "ALL": {
     ...
     */
    private static MatrixPayBillResult fromRawBillResultString(String responseContent) {
        String listStr = "";
        String objStr = "";
        ...
        List<MatrixPayBillInfo> results = new ArrayList<>();
        // 去空格
        ...
        int k = 1;
        for (int i = 0; i < j; i++) {
            MatrixPayBillInfo result = new MatrixPayBillInfo();
        ...
        MatrixPayBillResult billResult = new MatrixPayBillResult();
     ...
     */
    private static MatrixPayBillResult fromRawBillResultStringToSuccess(String responseContent) {
        String listStr = "";
        String objStr = "";
        if (responseContent.contains(TOTAL_DEAL_COUNT)) {
            listStr = responseContent.substring(0, responseContent.indexOf(TOTAL_DEAL_COUNT));
     ...
     */
    private static MatrixPayBillResult fromRawBillResultStringToRefund(String responseContent) {
        String listStr = "";
        String objStr = "";
        if (responseContent.contains(TOTAL_DEAL_COUNT)) {
            listStr = responseContent.substring(0, responseContent.indexOf(TOTAL_DEAL_COUNT));
     ...
     */
    private static MatrixPayBillResult fromRawBillResultStringToRechargeRefund(String responseContent) {
        String listStr = "";
        String objStr = "";
        if (responseContent.contains(TOTAL_DEAL_COUNT)) {
            listStr = responseContent.substring(0, responseContent.indexOf(TOTAL_DEAL_COUNT));
