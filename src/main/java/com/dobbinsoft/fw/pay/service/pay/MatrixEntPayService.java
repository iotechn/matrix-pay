...
import com.dobbinsoft.fw.pay.model.entpay.*;
...
public interface MatrixEntPayService {
     ...
     */
    MatrixEntPayResult entPay(MatrixEntPayRequest request) throws WxPayException;
     ...
     * @throws WxPayException the wx pay exception
     */
    MatrixEntPayQueryResult queryEntPay(String partnerTradeNo) throws WxPayException;
     ...
     * @throws WxPayException the wx pay exception
     */
    MatrixEntPayQueryResult queryEntPay(MatrixEntPayQueryRequest request) throws WxPayException;
     ...
     * @throws WxPayException the wx pay exception
     */
    MatrixEntPayBankResult payBank(MatrixEntPayBankRequest request) throws WxPayException;
     ...
     * @throws WxPayException the wx pay exception
     */
    MatrixEntPayBankQueryResult queryPayBank(String partnerTradeNo) throws WxPayException;
     ...
     * @throws WxPayException the wx pay exception
     */
    MatrixEntPayBankQueryResult queryPayBank(EntPayBankQueryRequest request) throws WxPayException;
}
